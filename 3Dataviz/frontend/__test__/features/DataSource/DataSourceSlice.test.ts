...
import reducer, { requestDatasets, selectorCurrentDataset, selectorDatasets, trySetCurrentDataset } from "../../../src/features/DataSource/DataSourceSlice";
...
describe("DataSourceSlice", ()=>{
    ...
    it("Selezione di un dataset",() => {
        ...
        expect(reducer(initialState,trySetCurrentDataset(0))).toEqual(expectedState);
    ...
    it("Selezione di un dataset non esistente",() => {
        ...
        expect(reducer(initialState,trySetCurrentDataset(5))).toEqual(expectedState);
    ...
    it("Prendere il dataset selezionato",() => {
        ...
        expect(selectorCurrentDataset(initialState)).toEqual(initialState.currentDataset);
    });
});