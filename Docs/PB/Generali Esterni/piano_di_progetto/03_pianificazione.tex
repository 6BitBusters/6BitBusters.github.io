...
\subsubsection{Sprint 10 (dal 31/03/2025 al 11/03/2025)}  
L'obiettivo principale di questo sprint è completare la progettazione di dettaglio del backend e del frontend. In particolare, finalizzeremo i diagrammi UML e la sezione 
Architettura nella \textit{Specifica tecnica}. Conclusa questa fase, daremo avvio alla codifica del software, partendo dalla configurazione dell'ambiente di sviluppo 
e dall'implementazione delle action per la CI.
