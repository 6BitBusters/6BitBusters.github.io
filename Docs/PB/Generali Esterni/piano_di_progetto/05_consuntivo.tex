...
\begin{itemize}
    ...
    \item \textbf{Programmatore +4}: a seguito degli incontri, si è reso necessario analizzare e confrontare ulteriori API rispetto a quelle inizialmente previste; 
...
\noindent Il costo totale del progetto è di \euro{10685}, che include le ore di lavoro effettive impiegate da ciascun membro del gruppo.
Rispetto al costo di fine progetto preventivato di \euro{11065}, il costo finale è inferiore di \euro{380}. Questo è dovuto a delle ore avanzate da alcuni membri del gruppo.
