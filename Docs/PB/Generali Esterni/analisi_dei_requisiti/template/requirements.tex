...
\begin{longtable}{ %0.89
		>{\centering}M{0.10\textwidth} 
		>{\centering}M{0.47\textwidth}
...
\newcommand{\requirementsHWTable}[1]{
...
\begin{longtable}{ %0.87
	...
	\rowcolorhead
	\headertitle{Componente} &
	\centering \headertitle{Modello}
	\endfirsthead	
	\endhead
