...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item RouterProvider (associazione): componente React che gestisce le pagine dell'applicazione web e le loro relative rotte.
        \end{itemize} 
    \end{itemize}
    ...
    \begin{itemize}
        \item \textbf{Dipendenze:}
        \begin{itemize}
            \item SelectionPage (composizione): componente React che offre all'utente l'interfaccia per la scelta del dataset desiderato;
...
\begin{itemize}
    ...
    \begin{itemize}
        \item \textbf{Dipendenze:}
        \begin{itemize}
            \item UI (composizione): componente React che avvolge e gestisce l'intera interfaccia utente (UI) dell'applicazione web;
...
\begin{itemize}
    ...
    \begin{itemize}
        \item \textbf{Dipendenze:}
        \begin{itemize}
            \item Footer (composizione): componente React dedicato alla visualizzazione del footer dell'applicazione web;
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item BarChart (composizione): componente React che racchiude e gestisce l'intera struttura del grafico tridimensionale.
        \end{itemize} 
    \end{itemize}
\end{itemize}
...
\end{figure}
\textbf{Descrizione del diagramma:}
Questo diagramma presenta gli elementi che costituiscono il grafico tridimensionale.
\begin{itemize}
    \item \textbf{BarChart:}
    \begin{itemize}
        \item \textbf{Dipendenze:}
        \begin{itemize}
            \item Axis (composizione): componente React che contiene gli assi X, Y e Z del grafico tridimensionale;
            ...
            \item Bar (composizione): componente React dedicato al rendering degli elementi che rappresentano le barre all'interno del grafico tridimensionale.
        \end{itemize} 
    \end{itemize}
...
\end{figure}
\textbf{Descrizione del diagramma:}
Questo diagramma presenta gli elementi che costituiscono ciascuno dei tre assi del grafico tridimensionale.
\begin{itemize}
    \item \textbf{Axis:}
    \begin{itemize}
        \item \textbf{Dipendenze:}
        \begin{itemize}
            \item XAxis (composizione): componente React che rappresenta l'asse X del grafico tridimensionale con relative etichette;
            \item YAxis (composizione): componente React che rappresenta l'asse Y del grafico tridimensionale con relative etichette;
            \item ZAxis (composizione): componente React che rappresenta l'asse Z del grafico tridimensionale con relative etichette.
        \end{itemize} 
    \end{itemize}
\end{itemize}