...
\begin{itemize}
        ...
        \item \textbf{FViewOptionSlice:} componente che gestisce lo stato e contiene le opzioni di visibilità del piano medio;
...
\paragraph{Action}
    ...
    \begin{itemize}
        ...
        \item \textbf{ViewOptionSlice.toggleAveragePlane:} action emessa per aggiornare il flag di visibilità del piano medio globale nell'ambiente tridimensionale; \\ Payload: boolean 
...
\paragraph{Classi}
    ...
    \begin{itemize}
        ...
        \item \textbf{Gsap:} classe utility della libreria gasp che permette di creare animazioni sia dell'interfaccia utente e sia all'interno dell'ambiente tridimensionale con facilità e poco codice.
    \end{itemize}
...
\paragraph{Componenti tridimensionali di Three.js}
    ...
    \begin{itemize}
        \item \textbf{EnvironmentPage:} componente che permette di visualizzare la pagina in cui viene renderizzato l'ambiente tridimensionale;
        ...
        \item \textbf{Bar:} componente che permette di visualizzare una singola barra in un grafico 3D;
...
\begin{itemize}
    ...
    \begin{itemize}
        \item \textbf{Dipendenze:}
        \begin{itemize}
            \item RaycastHit (associazione): contiene l'oggetto che rappresenta il punto di intersezione tra il puntatore/cursore del mouse e una barra del grafico.
        \end{itemize} 
    \end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item EnvironmentPage (composizione): componente React che fornisce l'interfaccia per visualizzare un dataset in un ambiente tridimensionale;
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item AveragePlaneOption (composizione): componente React che visualizza un form per permettere all'utente di attivare o disattivare la visualizzazione del piano del valor medio.
        \end{itemize} 
    \end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Raycaster (composizione): componente React che implementa la logica per determinare se e dove il puntatore/cursore del mouse interseca una barra del grafico;
