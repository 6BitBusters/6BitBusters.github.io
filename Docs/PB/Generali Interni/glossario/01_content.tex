...
\section{B}
    ...
    \subsection{Bundle}
    (s. c. m.)\\
    File unico che contiene codice combinato e ottimizzato per migliorare le prestazioni, usato dai 
    strumenti come Vite.
\pagebreak
\section{C}
...
\section{H}
    ...
    \subsection{Hook}
    (s. c. m.)\\
    Funzione che consente di "agganciare" funzionalità di React come i metodi di 
    stati o di cicli di vita. Permettendo di gestire la logica all'interno di un componente funzionale.
    \subsection{Hotfix}
    (s. c. m.)\\
