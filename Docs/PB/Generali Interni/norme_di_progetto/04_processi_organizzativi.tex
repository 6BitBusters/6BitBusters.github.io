...
\subsubsubsection{Ruoli e responsabilità}
...
\subsubsubsection{Modalità di comunicazione}
...
\subsubsubsection{Modalità di riunione}
\noindent \textbf{Interne} \\
...
\subsubsubsection{Project board}\label{inf:pb}
...
\subsubsubsection{Issue Tracking System}\label{inf:its}
...
\subsubsubsection{Gestione dei dubbi e dei conflitti}
