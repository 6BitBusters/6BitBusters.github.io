...
\requirementsTable{
    ...
    \RFM & L’utente deve poter inserire un numero per effetuare un filtraggio & Obbligatorio & UC16\par UC16.3\tabularnewline
    ...
    \RFD & L’utente deve poter visualizzare un piano parallelo alla base che rappresenti il valor medio di un singolo elemento  & Desiderabile & UC19\par UC19.2\tabularnewline
...
\requirementsTable{
    ...
    \RVO & Le barre de grafico 3D devono avere una colorazione appropriata che renda i relativi valori facilmente e velocemente comprensibili  & Opzionale & VE 2024-12-19 \tabularnewline
    }
\newpage
