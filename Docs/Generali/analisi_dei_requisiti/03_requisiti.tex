...
\requirementsTable{
    ...
    \RFM & L’utente deve poter filtrare un numero N dei valori più alti & Obbligatorio & UC16.1\tabularnewline
    \RFM & L’utente deve poter filtrare un numero N dei valori più bassi & Obbligatorio & UC16.2\tabularnewline
    \RFM & L’utente deve poter inserire un numero per effetuare un filtraggio & Obbligatorio & UC16.3\tabularnewline
    \RFM & L’utente deve poter eseguire un filtraggio rispetto a un valore & Obbligatorio & UC17\tabularnewline
    \RFM & L’utente deve poter filtrare i valori inferiori o uguali rispetto a un valore del grafico & Obbligatorio & UC17.1\par UC17.1.1\tabularnewline
    \RFM & L’utente deve poter filtrare i valori inferiori o uguali rispetto al valor medio globale & Obbligatorio & UC17.1\par UC17.1.2\tabularnewline
    \RFM & L’utente deve poter filtrare i valori superiori o uguali rispetto a un valore del grafico & Obbligatorio & UC17.2\par UC17.2.1\tabularnewline
    \RFM & L’utente deve poter filtrare i valori superiori o uguali rispetto al valor medio globale & Obbligatorio & UC17.2\par UC17.2.2\tabularnewline
...
\SrcToReqTable{
    ...
    UC17.1    & RF28\par RF29 \tabularnewline
    UC17.1.1    & RF28 \tabularnewline
    UC17.1.2    & RF29 \tabularnewline
    UC17.2    & RF30\par RF31 \tabularnewline
    UC17.2.1    & RF30 \tabularnewline
...
\ReqToUCTable{
    ...
    RF28 & UC17.1\par UC17.1.1 \tabularnewline
    RF29 & UC17.1\par UC17.1.2 \tabularnewline
    RF30 & UC17.2\par UC17.2.1 \tabularnewline
    RF31 & UC17.2\par UC17.2.2 \tabularnewline
