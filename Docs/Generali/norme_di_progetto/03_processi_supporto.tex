...
I processi di supporto contribuiscono a rendere i processi primari più efficienti ed efficaci.
    ...
    \begin{itemize}
        ...
        tutta la documentazione creata fino a quel momento e di creare la pagina web tramite Pages;
    ...
    \end{itemize}
    Al fine di garantire la qualità dei documenti prodotti, è necessario che le Action \texttt{pr\_build\_check.yml}
    e \texttt{pr\_gulpease\_check.yml} abbiano esito positivo. A tale scopo, è stato configurato il repository in modo
