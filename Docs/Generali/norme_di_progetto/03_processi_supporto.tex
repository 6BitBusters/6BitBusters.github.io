...
marcatura per la preparazione di testi. È fortemente consigliato l'uso di Visual 
Studio Code, un IDE che supporta numerose estensioni, tra cui LaTeX Workshop, per 
la compilazione di sorgenti '.tex' e l'anteprima del documento in formato '.pdf'. 
I documenti seguono una struttura comune:
\begin{itemize}
...
informazioni utili per il gruppo. Tali documenti saranno comunque resi pubblici all'interno
del repository, e nella pagina web creata tramite GitHub Pages\textsubscript{g}.\\ 
