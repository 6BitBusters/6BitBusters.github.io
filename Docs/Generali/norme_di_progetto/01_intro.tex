\section{Introduzione}
    ...
    \textit{3Dataviz} è un prodotto ideato dall'azienda proponente \textit{Sanmarco Informatica S.p.A.} per rendere la visualizzazione dei dati più semplice e accessibile.\\
    Il progetto si basa sul concetto di data visualization, ovvero il processo di trasformazione dei dati in grafici e rappresentazioni visive, sfruttando la capacità del nostro cervello di elaborare immagini in modo rapido e intuitivo. 
    Questo approccio facilita il processo decisionale e migliora la comprensione delle informazioni.\\
    L’obiettivo principale è lo sviluppo di un’interfaccia web in grado di trasformare dati provenienti da diverse fonti (come database e REST API) in grafici 3D interattivi e navigabili. 
    ...
    Nel presente documento, tutti i termini che richiedono spiegazioni sono indicati con il pedice “g”. \\
    Questa convenzione consente un rapido collegamento tra il testo principale e la relativa spiegazione dettagliata presente nel glossario, garantendo coerenza e chiarezza nella comunicazione.
