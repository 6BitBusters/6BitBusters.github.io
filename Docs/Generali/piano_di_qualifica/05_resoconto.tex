...
{ % DESCRIZIONE RTB
 Analizzando i grafici di Earned Value, Planned Value e Actual Cost si può notare come siano tutti e 3 allineati. 
...
{ % DESCRIZIONE RTB
    L'analisi del grafico evidenzia che, inizialmente, l'assenza di un WoW solido ha impedito al team di rispettare le tempistiche previste, come dimostrato da uno Schedule Variance negativo. 
...
{ % DESCRIZIONE RTB
    L'analisi del grafico indica che il team sta impiegando un po' meno risorse rispetto alle previsioni iniziali, dimostrando una gestione efficiente e un'ottima capacità di adattamento alle esigenze del progetto.
}
...
{ % DESCRIZIONE RTB  
    Come descritto dal grafico il team non ha quasi mai avuto problemi riguardante la completezza dei documenti. 
    A ogni sprint tutti i membri si sono impegnati al massimo per garantire il completamento delle attività assegnate, ossia la redazione delle varie sezioni dei documenti.
}
