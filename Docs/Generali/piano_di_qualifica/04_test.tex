...
\testTable{
    TA1 & Verifica che all'avvio del sistema sia visibile all'utente la lista
    dei dataset disponibili & NI\tabularnewline
    ...
    TA4 & Verifica che l'utente possa  & NI\tabularnewline
