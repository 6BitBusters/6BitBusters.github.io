...
\testTable{
    ...
    TS34 & Verifica che l'utente possa eseguire un filtraggio su valori inferiori o uguali al valore scelto & NI\tabularnewline
    TS35 & Verifica che l'utente possa eseguire un filtraggio su valori inferiori o uguali rispetto al valor medio globale & NI\tabularnewline
    TS36 & Verifica che l'utente possa eseguire un filtraggio su valori superiori o uguali al valore scelto & NI\tabularnewline
    TS37 & Verifica che l'utente possa eseguire un filtraggio su valori superiori o uguali rispetto al valor medio globale & NI\tabularnewline
